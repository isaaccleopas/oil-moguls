<template>
  <div class="om-pin-section">
    <SectionPin label="Opportunity Board" />
    <PageHero title="Your next role should not depend on who you happen to know.">
  ...
  <section class="om-pin-section">
    <SectionPin label="How the board works" />
    <div class="om-container py-16 sm:py-24">
      <SectionHeading title="Verified in. Noise out.">
      ...
      <p class="mt-4 text-sm text-muted">Illustrative listings. Live roles appear to members after verification.</p>
    </div>
  </section>
  <section class="om-pin-section border-t border-line bg-white">
    <SectionPin label="Next step" />
    <div class="om-container om-pin-close grid gap-8 py-16 sm:py-24 lg:grid-cols-3">
      <div class="lg:col-span-2">
        <h2 class="om-display text-3xl">Apply from a profile that already proves the work.</h2>
        <p class="om-body mt-4 max-w-xl">The board is connected to Academy progress and community standing. That is the difference between a job feed and career infrastructure.</p>
      </div>
      <div class="flex items-end">
        <RouterLink to="/join" class="om-btn om-btn-primary w-full lg:w-auto">See verified roles</RouterLink>
      </div>
    </div>
  </section>
</template>
